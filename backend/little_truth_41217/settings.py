"""
Django settings for little_truth_41217 project.
...
ROOT_URLCONF = 'little_truth_41217.urls'
...
WSGI_APPLICATION = 'little_truth_41217.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_truth_41217 API",
    "DESCRIPTION": "API documentation for little_truth_41217 App",
    "VERSION": "v1",
}
